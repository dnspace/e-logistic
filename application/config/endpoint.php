...
$config['api_update_delivery_note_detail_status'] = constant('urlapi').'api/cpdeliverynote/update_detail_status/'; //POST
$config['api_update_delivery_note_detail_id'] = constant('urlapi').'api/cpdeliverynote/update_detail_by_id/'; //POST
$config['api_update_delivery_note_detail_all'] = constant('urlapi').'api/cpdeliverynote/update_detail_all/'; //POST
...
$config['api_list_data_delivery_note'] = constant('urlapi').'api/cpdeliverynote/list_data/'; //POST
