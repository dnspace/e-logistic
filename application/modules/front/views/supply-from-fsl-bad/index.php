<div class="row">
    ...
    <div class="col-md-9">
        <div class="card-box">
            <button type="button" onclick="location.href='<?php echo base_url("add-supply-from-fsl-bad");?>'" class="btn btn-custom btn-rounded w-md waves-effect waves-light">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var table = $('#data_grid').DataTable({
            ...
            ajax: {                
                url: '<?php echo base_url('front/csupplyfromfslbad/get_list_view_datatable'); ?>',
                type: 'POST',
                headers: {'Content-Type': 'application/x-www-form-urlencoded'},
                dataType: 'JSON',
                contentType:"application/json",
