                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="column col-md-12">
										...
										<p class="font-13"><strong>Estimate Time of Arrival :</strong> <span class="m-l-10" id="veta">-</span></p>
										<p class="font-13"><strong>Status :</strong> <span class="m-l-10" id="vstatus">-</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">    
    ...
    var e_eta = $('#veta');
    var e_status = $('#vstatus');
    var trans_purpose = "";
    var total_qty_transfer = 0, detail_ret_qty = 0;
    var table;
    var arrStatus = [];
    ...
    function init_table(){
        ...
        table = $('#data_grid').DataTable({
                ...
                },
                {
                    ...
                    render    : function ( data, type, full, meta ) {
                        ...
                        if(isEmpty(data) || data == "-"){
                            ...
                            var status = full.return_status.toUpperCase();
            ...
            rowCallback: function( row, data, index ) {
                fid = data.dt_delivery_note_id;
                fpartnum = data.part_number;
                fserialnum = data.serial_number;
                fqty = data.dt_delivery_note_qty;
                fstatus = data.return_status;
                fcomplete = "complete";
                fnotes = data.dt_notes;
        ...
        $('#data_grid tbody').on( 'click', '#btn_edit', function (e) {        
            ...
            fid = data['dt_delivery_note_id'];
            fpartno = data['part_number'];
            fserialno = data['serial_number'];
            fqty = data['dt_delivery_note_qty'];
            fnotes = data['dt_notes'];
            fstatus = data['return_status'];
    ...
    function check_transfer_reff(transnum){
        var url = '<?php echo base_url('api-delivery-note-check-trans'); ?>';
        var type = 'GET';
        ...
        var throw_ajax_success = function (jqXHR) {
            if(jqXHR.status === 0){
                ...
                total_qty_transfer = parseInt(jqXHR.total_qty);
                e_trans_out.prop('readonly', true);
    ...
    function get_transfered_detail(transnum){
        var url = '<?php echo base_url('api-delivery-note-get-transfer'); ?>';
        var type = 'GET';
    ...
    function update_detail(){
        ...
        var url = '<?php echo base_url('api-delivery-note-edit-detail-id'); ?>';
        var type = 'POST';
    ...
    function update_detail_status_all(ftrans_out, fstatus){
        var url = '<?php echo base_url('api-delivery-note-edit-detail-status-all'); ?>';
        var type = 'POST';
