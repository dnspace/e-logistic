    ...
    <div class="col-md-12">
        <div class="card-box">
            ...
            <?php 
                ...
                if($hashub){
            ?>
                <div class="col-md-6"> <form id="frm_act" action="<?=$link_print;?>" method="POST">
                    <div class="row">
                        <label for="fcode" class="col-md-3 col-form-label">Warehouse</label>
                        <div class="col-md-6">
                            <select name="fcode[]" id="fcode" class="selectpicker form-control" multiple data-actions-box="true" 
                        ...
                        <div class="col-md-3">
                            <a id="print" href="javascript:;" class="btn btn-info waves-effect"><i class="mdi mdi-document vertical-middle"></i>Print</a>
                        </div>
                        </form>
                    </div>
                </div>
    ...
    */
    ...
    $(document).ready(function() {
        ...
        btn_print.on('click',function(e){
            // $.post('<?=$link_print;?>',{'fcode[]':$('#fcode').val()}).done(function(data){
